import { Major } from '@/components/academic/major/major-card'
import { Facility } from '@/services/api/useQueries/useFacility'
import { backendUrl } from '@/utils/backendUrl'
import React from 'react'

const DetailLayout = ({ children, detailData }: { children: React.ReactNode, detailData: Major | Facility }) => {
    return (
    ...
    style={{
        backgroundImage: `url(${ 'facility_image' in detailData ? backendUrl + detailData.facility_image : detailData.img })`
    }}
>
