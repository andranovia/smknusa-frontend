    ...
    <div className="w-full pt-20 lg:pt-24 px-3 rounded-[10px] text-blue-base">
      <div className="relative  bg-white flex flex-col items-center  pt-10 pb-20">
        <div className="flex flex-col lg:items-center gap-4 w-[80%] lg:w-2/3 lg:text-center">
          <Heading type="h1">Visi dan Misi Sekolah</Heading>
        ...
        <div className="flex flex-col items-start gap-8 mt-10  w-[80%]">
          <span className="flex flex-col items-start gap-4">
            ...
            <Paragraph>
              Terwujudnya Tamatan yang Beriman dan Bertaqwa kepada Tuhan Yang
              Maha Esa, berbudi pekerti luhur, berdaya saing tinggi, peduli dan
          ...
          <span className="flex flex-col items-start gap-4">
            ...
            <List className="flex flex-col gap-2 mx-2">
              ...
              <li>
                Mengembangkan pengetahuan, keterampilan, disiplin diri, etos
                kerja yang tinggi, aktif, kreatif, inovatif, dan budaya santun
                sesuai bidangnya
              </li>
              <li>
              ...
              <li>
                Mengembangkan budaya sekolah untuk melestarikan fungsi
                lingkungan, mencegah pencemaran dan kerusakan lingkungan
              </li>
              <li>
              ...
              <li>
                Mengembangkan pola kemitraan dengan masyarakat dan industri
              </li>
              <li>
