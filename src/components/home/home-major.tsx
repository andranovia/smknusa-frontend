  ...
  return (
    <section className="w-full h-full bg-white rounded-[10px]">
      <div className="flex flex-col lg:text-center w-full items-center justify-center bg-primary  rounded-md text-white pt-6 sm:pt-10 pb-16 xl:pb-48">
        <Heading type="h1" className="xl:text-[36px]  text-[22px] lg:text-[30px] sm:text-[24px] w-full max-w-xs-content sm:max-w-sm-content md:max-w-md-content lg:max-w-lg-content xl:max-w-xl-content 2xl:max-w-max-content xl:w-fit ">
          Menuju SMK Bisa,
          <br className="block sm:hidden" /> SMK Hebat
        </Heading>

        <Paragraph className=" text-sm xl:text-[18px] lg:text-[14px] xl:w-fit  mt-[12px] w-full max-w-xs-content sm:max-w-sm-content md:max-w-md-content lg:max-w-lg-content xl:max-w-xl-content 2xl:max-w-max-content">
      ...
      <div className="relative  xl:px-8 px-0  xl:-mt-32  ">
        <div className="flex justify-center items-end relative  bg-white overflow-hidden rounded-[10px] ">
          <div className="relative w-full  flex flex-col xl:flex-row   justify-center gap-14  h-full  mt-8 mb-10 xl:mb-0 max-w-max-content">
