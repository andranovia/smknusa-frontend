...
const ProfileLayout = ({
  ...
  return (
    <div className="w-full flex bg-gray-base justify-center pt-20 xl:pt-24 px-2  xl:px-2.5 min-h-screen rounded-[10px] text-blue-base">
      <div className="relative bg-white  rounded-md lg:min-h-screen flex flex-col items-center px-3 pt-10 pb-20 max-w-max  md:max-w-md-content lg:max-w-lg-content w-full xl:max-w-xl-content 2xl:max-w-max-content">
