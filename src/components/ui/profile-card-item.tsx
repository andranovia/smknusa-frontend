  ...
  return (
    <div className="bg-white rounded-lg sm:w-full 1xl:w-[23rem] h-full border overflow-hidden relative">
      <Image
        ...
        src={'extra_image' in profileCardData ? backendUrl + profileCardData.extra_image : backendUrl + profileCardData.kemitraan_thumbnail}
        alt={'extra_name' in profileCardData ? profileCardData.extra_name : profileCardData.kemitraan_name}
        width={800}
        height={800}
      />
