...
const StudentsForm = ({
  ...
  const [studentsFilterClass, setStudentsFilterClass] = useState('');
  ...
  const studentClassData = [
    ...
    'XI TM 1', 'XI TM 2',
    'XII TM 1', 'XII TM 2',
    'X ATPH 1', 'X ATPH 2', 'X ATPH 3',
    'XI ATPH 1', 'XI ATPH 2', 'XI ATPH 3',
    'XII ATPH 1', 'XII ATPH 2', 'XII ATPH 3', 
    'X APHP 1', 'X APHP 2', 'X APHP 3',
    'XI APHP 1', 'XI APHP 2', 'XI APHP 3',
    'XII APHP 1', 'XII APHP 2', 'XII APHP 3',
  ];
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 xl:gap-12 gap-4 mb-3">
            ...
            >
              <div className="py-1">
                <MenuItem>
                  <span
                    onClick={() => setStudentsFilterClass('')}
                    className={`${studentsFilterClass === '' ? 'bg-gray-200' : ''} block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:text-gray-900`}
                  >
                    Semua
                  </span>
                </MenuItem>
                {studentClassData.map((filter, index) => (
                  <MenuItem key={index}>
                    <span
                      onClick={() => setStudentsFilterClass(filter)}
