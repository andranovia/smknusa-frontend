  ...
  return (
    <>
      <div className=" lg:w-full h-full lg:h-[78rem]  flex flex-col items-center justify-center bg-white rounded-[10px] mt-3">
        <div className="relative flex h-3/4 flex-col items-center justify-center gap-8 bg-primary  rounded-md text-white pt-14 pb-32">
          <h1 className="font-[700]  lg:text-[36px] text-[24px] lg:text-center w-4/5">
            SMKN 1 Purwosari <br className="hidden lg:block"/> Bekerjasama Dengan Beberapa Perusahaan
          </h1>
