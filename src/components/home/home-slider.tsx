...
const HomeSlider = () => {
  return (
    <>
      <div className="text-[#081B34] w-full flex justify-center overflow-hidden relative  items-center my-4 rounded-md bg-white py-6 ">
            ...
            <React.Fragment key={index}>
              <div className="flex items-center ">
                <Image
                  ...
                  className="mx-10"
                />
                <h2 className="font-[500] text-[22px]">{data.text}</h2>
              </div>
            </React.Fragment>
          ))}
        </Marquee>
